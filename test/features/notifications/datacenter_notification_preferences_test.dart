...
void main() {
  test('persists a connection reachability baseline', () {
    const preferences = DatacenterNotificationPreferences(
    ...
    final decoded = DatacenterNotificationPreferences.fromJson(
      preferences.toJson().map<String, Object?>(MapEntry<String, Object?>.new),
    );
